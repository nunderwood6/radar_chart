	...
	*/
	...
	d.forEach(function(y, x){
	  ...
	  g.selectAll(".area")
					 ...
					 var age = (parseFloat(d3.select(this).attr("class")
 						 .replace("radar-chart-serie", "")) + 1) * 1000;
...
console.log(formattedData);
    var singleSite = formattedData[8];
    var d = formatRadar(singleSite);
    console.log(singleSite);
    console.log(formatRadar(singleSite));
